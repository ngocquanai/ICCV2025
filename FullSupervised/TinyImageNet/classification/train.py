...
from utils import HieraCrossEntropy
...
def main(args):
    ...
    for epoch in tqdm(range(args.start_epoch, args.epochs)):
        ...
        if args.output_dir:
            ...
            if acc1 > best_acc1:
                print("Curent best ACC: ", acc1, "-"*100)
                best_acc1 = max(acc1, best_acc1)
                if acc1 > 30 :
                    utils.save_on_master(checkpoint, os.path.join(args.output_dir, f"checkpoint_best_epoch-{epoch}_acc-{acc1}.pth"))
        print(acc1)
